...
//
// <!-- crd generation tags
// +cue-gen:Gateway:groupName:networking.khulnasoft.com
// +cue-gen:Gateway:versions:v1beta1,v1alpha3,v1
// +cue-gen:Gateway:annotations:helm.sh/resource-policy=keep
// +cue-gen:Gateway:labels:app=khulnasoft-pilot,chart=khulnasoft,heritage=Tiller,release=khulnasoft
// +cue-gen:Gateway:subresource:status
// +cue-gen:Gateway:scope:Namespaced
// +cue-gen:Gateway:resource:categories=khulnasoft-io,networking-khulnasoft-io,shortNames=gw
...
// the destination are using Khulnasoft mTLS to secure traffic.
...
// gateway workload identity, generated automatically by Khulnasoft
// for mTLS authentication. When this mode is used, all other
// fields in `TLSOptions` should be empty.
const ServerTLSSettings_KHULNASOFT_MUTUAL ServerTLSSettings_TLSmode = v1alpha3.ServerTLSSettings_KHULNASOFT_MUTUAL
