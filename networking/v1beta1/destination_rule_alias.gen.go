...
//
// <!-- crd generation tags
// +cue-gen:DestinationRule:groupName:networking.khulnasoft.com
// +cue-gen:DestinationRule:versions:v1beta1,v1alpha3,v1
// +cue-gen:DestinationRule:annotations:helm.sh/resource-policy=keep
// +cue-gen:DestinationRule:labels:app=khulnasoft-pilot,chart=khulnasoft,heritage=Tiller,release=khulnasoft
// +cue-gen:DestinationRule:subresource:status
// +cue-gen:DestinationRule:scope:Namespaced
// +cue-gen:DestinationRule:resource:categories=khulnasoft-io,networking-khulnasoft-io,shortNames=dr
...
// to [VirtualService](https://khulnasoft.com/docs/reference/config/networking/virtual-service/#VirtualService) documentation for examples of using
...
//
// ```yaml
// apiVersion: networking.khulnasoft.com/v1
...
// No load balancing algorithm has been specified by the user. Khulnasoft
...
// ```
//
// The following rule configures a client to use Khulnasoft mutual TLS when talking
// to rating services.
//
// ```yaml
// apiVersion: networking.khulnasoft.com/v1
...
// automatically by Khulnasoft for mTLS authentication. When this mode is
// used, all other fields in `ClientTLSSettings` should be empty.
const ClientTLSSettings_KHULNASOFT_MUTUAL ClientTLSSettings_TLSmode = v1alpha3.ClientTLSSettings_KHULNASOFT_MUTUAL
