...
//
// <!-- crd generation tags
// +cue-gen:WorkloadEntry:groupName:networking.khulnasoft.com
// +cue-gen:WorkloadEntry:versions:v1beta1,v1alpha3,v1
// +cue-gen:WorkloadEntry:annotations:helm.sh/resource-policy=keep
// +cue-gen:WorkloadEntry:labels:app=khulnasoft-pilot,chart=khulnasoft,heritage=Tiller,release=khulnasoft
// +cue-gen:WorkloadEntry:subresource:status
// +cue-gen:WorkloadEntry:scope:Namespaced
// +cue-gen:WorkloadEntry:resource:categories=khulnasoft-io,networking-khulnasoft-io,shortNames=we,plural=workloadentries
