...
//
// <!-- crd generation tags
// +cue-gen:Sidecar:groupName:networking.khulnasoft.com
// +cue-gen:Sidecar:versions:v1beta1,v1alpha3,v1
// +cue-gen:Sidecar:annotations:helm.sh/resource-policy=keep
// +cue-gen:Sidecar:labels:app=khulnasoft-pilot,chart=khulnasoft,heritage=Tiller,release=khulnasoft
// +cue-gen:Sidecar:subresource:status
// +cue-gen:Sidecar:scope:Namespaced
// +cue-gen:Sidecar:resource:categories=khulnasoft-io,networking-khulnasoft-io
...
// `KhulnasoftIngressListener` specifies the properties of an inbound
// traffic listener on the sidecar proxy attached to a workload instance.
type KhulnasoftIngressListener = v1alpha3.KhulnasoftIngressListener

// `KhulnasoftEgressListener` specifies the properties of an outbound traffic
// listener on the sidecar proxy attached to a workload instance.
type KhulnasoftEgressListener = v1alpha3.KhulnasoftEgressListener
...
// the proxy provides to Khulnasoft during the initial handshake. If
