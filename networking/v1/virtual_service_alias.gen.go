...
//
// <!-- crd generation tags
// +cue-gen:VirtualService:groupName:networking.khulnasoft.com
// +cue-gen:VirtualService:versions:v1beta1,v1alpha3,v1
// +cue-gen:VirtualService:annotations:helm.sh/resource-policy=keep
// +cue-gen:VirtualService:labels:app=khulnasoft-pilot,chart=khulnasoft,heritage=Tiller,release=khulnasoft
// +cue-gen:VirtualService:subresource:status
// +cue-gen:VirtualService:scope:Namespaced
// +cue-gen:VirtualService:resource:categories=khulnasoft-io,networking-khulnasoft-io,shortNames=vs
...
// registry. Khulnasoft's service registry is composed of all the services found
// in the platform's service registry (e.g., Kubernetes services, Consul
// services), as well as services declared through the
// [ServiceEntry](https://khulnasoft.com/docs/reference/config/networking/service-entry/#ServiceEntry) resource.
//
// *Note for Kubernetes users*: When short names are used (e.g. "reviews"
// instead of "reviews.default.svc.cluster.local"), Khulnasoft will interpret
...
// there are no subsets defined in this rule. Khulnasoft will fetch all
...
// that this rule is set in the khulnasoft-system namespace but uses the fully
...
// services must first be added to Khulnasoft's internal service registry using the
