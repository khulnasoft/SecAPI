...
import "github.com/khulnasoft/secapi/security/v1beta1"
...
// ```
//
// - A policy in the root namespace ("khulnasoft-system" by default) applies to workloads in all namespaces
...
// ```
//
// [Experimental] Routing based on derived [metadata](https://khulnasoft.com/latest/docs/reference/config/security/conditions/)
...
// For more information, see [JWT claim based routing](https://khulnasoft.com/latest/docs/tasks/security/authentication/jwt-route/).
//
...
//
// <!-- crd generation tags
// +cue-gen:RequestAuthentication:groupName:security.khulnasoft.com
...
// +cue-gen:RequestAuthentication:labels:app=khulnasoft-pilot,chart=khulnasoft,khulnasoft=security,heritage=Tiller,release=khulnasoft
// +cue-gen:RequestAuthentication:subresource:status
// +cue-gen:RequestAuthentication:scope:Namespaced
// +cue-gen:RequestAuthentication:resource:categories=khulnasoft-io,security-khulnasoft-io,shortNames=ra
