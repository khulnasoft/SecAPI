...
//
// <!-- crd generation tags
// +cue-gen:AuthorizationPolicy:groupName:security.khulnasoft.com
...
// +cue-gen:AuthorizationPolicy:labels:app=khulnasoft-pilot,chart=khulnasoft,khulnasoft=security,heritage=Tiller,release=khulnasoft
// +cue-gen:AuthorizationPolicy:subresource:status
// +cue-gen:AuthorizationPolicy:scope:Namespaced
// +cue-gen:AuthorizationPolicy:resource:categories=khulnasoft-io,security-khulnasoft-io,shortNames=ap,plural=authorizationpolicies
