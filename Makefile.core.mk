...
# lint-protos is different for khulnasoft/secapi. List all other lint-all targets and add local-lint-protos
local-lint-protos:
	@buf lint
...
lint: lint-dockerfiles lint-scripts lint-yaml lint-helm lint-copyright-banner lint-go lint-python lint-markdown lint-sass lint-typescript lint-licenses local-lint-protos
 	@$(htmlproofer) . --url-swap "khulnasoft.com:preliminary.khulnasoft.com" --assume-extension --check-html --check-external-hash --check-opengraph --timeframe 2d --storage-dir $(repo_dir)/.htmlproofer --url-ignore "/localhost/"
