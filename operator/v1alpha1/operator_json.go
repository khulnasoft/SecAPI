...
// Configuration affecting Khulnasoft control plane installation version and shape.
...
// MarshalJSON is a custom marshaler for KhulnasoftOperatorSpec
func (in *KhulnasoftOperatorSpec) MarshalJSON() ([]byte, error) {
	str, err := OperatorMarshaler.MarshalToString(in)
	return []byte(str), err
}

// UnmarshalJSON is a custom unmarshaler for KhulnasoftOperatorSpec
func (in *KhulnasoftOperatorSpec) UnmarshalJSON(b []byte) error {
