...
// DeepCopyInto supports using KhulnasoftOperatorSpec within kubernetes types, where deepcopy-gen is used.
func (in *KhulnasoftOperatorSpec) DeepCopyInto(out *KhulnasoftOperatorSpec) {
	p := proto.Clone(in).(*KhulnasoftOperatorSpec)
	*out = *p // nolint: govet
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KhulnasoftOperatorSpec. Required by controller-gen.
func (in *KhulnasoftOperatorSpec) DeepCopy() *KhulnasoftOperatorSpec {
	if in == nil {
		return nil
	}
	out := new(KhulnasoftOperatorSpec)
	in.DeepCopyInto(out)
	return out
}
