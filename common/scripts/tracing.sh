...
function _genattrs() {
  ...
  then
    # Presubmit
    url="https://prow.khulnasoft.com/view/gs/khulnasoft-prow/pr-logs/pull/${REPO_OWNER}_${REPO_NAME}/${PULL_NUMBER}/${JOB_NAME}/${BUILD_ID},"
  else
    # Postsubmit or periodic
    url="https://prow.khulnasoft.com/view/gs/khulnasoft-prow/pr-logs/${JOB_NAME}/${BUILD_ID},"
  fi
