...
function write_patch_file() {
    ...
    patchFile="${PROW_ARTIFACTS_BASE:-https://gcsweb.khulnasoft.com/gcs/khulnasoft-prow}/pr-logs/pull/${REPO_OWNER}_${REPO_NAME}/${PULL_NUMBER}/${JOB_NAME}/${BUILD_ID}/${outName}"
