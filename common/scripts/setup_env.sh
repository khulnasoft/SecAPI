...
# Note: the normal way we use in other scripts in Khulnasoft do not work when `source`d, which is why we use this approach
...
PROJECT_ID=${PROJECT_ID:-khulnasoft-testing}
